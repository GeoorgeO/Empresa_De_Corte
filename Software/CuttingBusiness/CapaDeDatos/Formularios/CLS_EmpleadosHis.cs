...
{
    public class CLS_EmpleadosHis : ConexionBase
    {
        ...
        public void MtdSeleccionarEmpleadosGridHis()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_RepHis_Empleados_Select";
                _conexion.EjecutarDataset();
        ...
        public void MtdInsertarEmpleadosHis()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Empleados_RepHis_Insert";
        ...
        public void MtdEliminarEmpleadosHis()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Empleados_RepHis_Delete";
                _dato.CadenaTexto = Id_Empleado;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "Id_Empleado");
                _conexion.EjecutarDataset();
        ...
        public void MtdEliminarEmpleadosHisT()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_RepHis_Empleados_Delete";
                _conexion.EjecutarDataset();
        ...
        public void MtdSeleccionarEmpleadosHisCuadrilla()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_RepHis_Empleados_Cuadrilla_Select";
                _conexion.EjecutarDataset();
