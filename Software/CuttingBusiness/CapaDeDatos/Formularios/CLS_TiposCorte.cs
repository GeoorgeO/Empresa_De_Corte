...
{
    public class CLS_TiposCorte : ConexionBase
    {
        ...
        public void MtdInsertarTiposCorte()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_TiposCorte_Insert";
        ...
        public void MtdEliminarTiposCorte()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_TiposCorte_Delete";
                _dato.CadenaTexto = Id_TipoCorte;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "Id_TipoCorte");
                _conexion.EjecutarDataset();
